var Mancala = function() {
    "use strict";
    var a = function(a) {
        this.game = a, this.playerOne_pits = [4, 4, 4, 4, 4, 4], this.playerTwo_pits = [4, 4, 4, 4, 4, 4], this.playerOne_store = 0, this.playerTwo_store = 0
    };
    return a.prototype.flip_board = function() {
        var a = this.playerOne_pits;
        this.playerOne_pits = this.playerTwo_pits, this.playerTwo_pits = a;
        var b = this.playerOne_store;
        this.playerOne_store = this.playerTwo_store, this.playerTwo_store = b
    }, a.prototype.get_stones = function(a) {
        return 6 === a ? this.playerOne_store : 13 === a ? this.playerTwo_store : 6 > a ? this.playerOne_pits[a] : a > 6 ? this.playerTwo_pits[a - 7] : NaN
...
! function() {
    ...
    Mancala.prototype.move_stones = function(a) {
        ...
        for (this.set_stones(a, 0), this.game.draw_stones(a); b > 0;) ++a, a > 12 && (a = 0), this.add_stones(a, 1), b--, this.game.draw_stones(a);
        var c = 5 - a;
        return 6 > a && 1 === this.playerOne_pits[a] && this.playerTwo_pits[c] > 0 && (this.playerOne_store += this.playerTwo_pits[c] + 1, this.game.draw_stones(6), this.playerOne_pits[a] = 0, this.playerTwo_pits[c] = 0, this.game.draw_stones(a), this.game.draw_stones(12 - a)), 6 !== a
    }
}(),
function() {
    "use strict";
    Mancala.prototype.check_winner = function() {
        ...
        return this.game.draw_all_stones(), this.playerOne_store > this.playerTwo_store ? "two" === this.game.player ? 2 : 1 : this.playerTwo_store > this.playerOne_store ? "two" === this.game.player ? 1 : 2 : 0
    }
}();
var Game = function() {
    "use strict";
    ...
    return a.prototype.init = function() {
        ...
        this.playerOne_player_pits = document.querySelectorAll(".row.player-" + this.player + " .pit p"), this.playerTwo_player_pits = document.querySelectorAll(".row.player-" + this.get_playerTwo_player() + " .pit p"), this.playerOne_player_store = document.querySelector(".store.player-" + this.player + " p"), this.playerTwo_player_store = document.querySelector(".store.player-" + this.get_playerTwo_player() + " p")
        ...
        this.player = this.get_playerTwo_player(), this.mancala.flip_board(), this.refresh_queries(), this.draw_all_stones();
        var a = this.player;
        setTimeout(function() {
            document.body.setAttribute("data-player", a), document.querySelector(".playerOne-player").textContent = a
        }, 700)
...
! function() {
    ...
    Game.prototype.draw_all_stones = function() {
        ...
        this.playerOne_player_store.textContent = a(this.mancala.playerOne_store), this.playerTwo_player_store.textContent = a(this.mancala.playerTwo_store);
        for (var b = 0; 6 > b; b++) this.playerOne_player_pits[b].textContent = a(this.mancala.playerOne_pits[b]), this.playerTwo_player_pits[b].textContent = a(this.mancala.playerTwo_pits[b])
...
function() {
    ...
    Game.prototype.load_game = function() {
        localStorage.getItem("stones") && (localStorage.removeItem("stones"), localStorage.removeItem("player")), localStorage.getItem("playerOne_pits") ? (this.mancala.playerOne_store = parseInt(localStorage.getItem("playerOne_store")), this.mancala.playerTwo_store = parseInt(localStorage.getItem("playerTwo_store")), this.mancala.playerOne_pits = JSON.parse(localStorage.getItem("playerOne_pits")), this.mancala.playerTwo_pits = JSON.parse(localStorage.getItem("playerTwo_pits")), "two" === localStorage.getItem("player") && this.switch_turn()) : this.save_game()
    }, Game.prototype.save_game = function() {
        localStorage.setItem("player", this.player), localStorage.setItem("playerOne_store", JSON.stringify(this.mancala.playerOne_store)), localStorage.setItem("playerTwo_store", JSON.stringify(this.mancala.playerTwo_store)), localStorage.setItem("playerOne_pits", JSON.stringify(this.mancala.playerOne_pits)), localStorage.setItem("playerTwo_pits", JSON.stringify(this.mancala.playerTwo_pits))
    }, Game.prototype.reset_game = function() {
        localStorage.removeItem("player"), localStorage.removeItem("playerOne_store"), localStorage.removeItem("playerTwo_store"), localStorage.removeItem("playerOne_pits"), localStorage.removeItem("playerTwo_pits")
    }
}();
var game = function() {
    "use strict";
